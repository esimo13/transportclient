...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/api/me`);
...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `http://localhost:3001/api/me/update`,
      userData,
      config
    );
...
export const updatePassword = (passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `http://localhost:3001/api/password/update`,
      passwords,
      config
    );
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `http://localhost:3001/api/password/reset/${token}`,
      passwords,
      config
    );
